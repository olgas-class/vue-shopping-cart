...
[X]1. Nella card predisporre le scelte di:
- colore
- memoria

[X]2. Al click sul colore viene visualizzata l'immagine del colore corrispondente

[X]3. Al click sulla memoria viene modificato il titolo del prodotto e il prezzo, tenendo in conto il surplus per opzione scelta
